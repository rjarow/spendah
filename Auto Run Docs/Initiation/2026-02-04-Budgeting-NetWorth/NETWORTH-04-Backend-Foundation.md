...
- [ ] Create BalanceHistory model for net worth over time:
...
- [ ] Create Net Worth API endpoints:
...
- [ ] Update Account API for balance management:
...
- [ ] Write tests for net worth functionality:
...
- [ ] Seed some account balance data for development:
